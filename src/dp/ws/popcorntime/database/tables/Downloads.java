...
public class Downloads implements BaseColumns {
	...
	public static final String _SUBTITLES_DATA_URL = "_subtitles_data_url";
	...
	public static final String QUERY_CREATE = "CREATE TABLE " + NAME + " (" + _ID + " INTEGER PRIMARY KEY, " + _TYPE + " TEXT, " + _IMDB + " TEXT, "
			+ _TORRENT_URL + " TEXT, " + _TORRENT_MAGNET + " TEXT, " + _FILE_NAME + " TEXT, " + _POSTER_URL + " TEXT, " + _TITLE + " TEXT, " + _SUMMARY
			+ " TEXT, " + _SUBTITLES_DATA_URL + " TEXT, " + _DIRECTORY + " TEXT, " + _TORRENT_FILE_PATH + " TEXT, " + _STATE + " INTEGER, " + _SIZE
			+ " INTEGER" + ")";
	...
	private static ContentValues buildValues(DownloadInfo info) {
		...
		values.put(_SUMMARY, info.summary);
		values.put(_SUBTITLES_DATA_URL, info.subtitlesDataUrl);
